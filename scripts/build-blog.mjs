...
<div id="av-root" style="position:relative;min-height:100vh;overflow:hidden">
  ...
  <div aria-hidden="true" style="position:fixed;inset:0;background-image:linear-gradient(var(--grid) 1px,transparent 1px),linear-gradient(90deg,var(--grid) 1px,transparent 1px);background-size:18px 18px;pointer-events:none;z-index:0"></div>
